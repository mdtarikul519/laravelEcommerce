        ...
        <div class="row">
          ...
          <section class="col-md-12">
            ...
            <div class="card">
              ...
              <div class="card-body">
            <form method="post" action="{{route('logos.update',$editdata->id)}}" id="myform" autocomplete="off"
               ...
               @csrf
                ...
                <div class="form_group col-md-2">
                 @if($editdata->image != null)
                  <img class="profile-user-img img-fluid img-circle" id="output" src="/upload/logo_images/{{ $editdata->image  }} " alt="User profile picture">
                  @else
