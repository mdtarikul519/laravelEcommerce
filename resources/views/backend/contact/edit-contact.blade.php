          ...
          <section class="col-md-12">
            ...
            <div class="card">
              <div class="card-header">
                <h3>Edit Contact
                 <a class="btn btn-success float-right" href="{{route('contacts.view')}}"><i class="fa fa-list"></i>Edit List</a>
                </h3>
              </div><!-- /.card-header -->
              <div class="card-body">
            <form method="post" action="{{route('contacts.update',$editdata->id)}}" id="myform" autocomplete="off"
              enctype="multipart/form-data">
               ...
               <div class="form_row">
                  ...
                  <div class="form_group col-md-4">
                  <label for="phon_no">Phon</label>
                  <input type="text" name="phon_no" value="{{$editdata->phon_no}}" class="form-control">
                 </div>
                  <div class="form_group col-md-4">
