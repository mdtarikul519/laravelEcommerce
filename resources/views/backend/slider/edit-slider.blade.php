        ...
        <div class="row">
          ...
          <section class="col-md-12">
            ...
            <div class="card">
              ...
              <div class="card-body">
            <form method="post" action="{{route('sliders.update',$editdata->id)}}" id="myform" autocomplete="off"
              enctype="multipart/form-data">
               @csrf
                <div class="form_row">
                  ...
                  <input type="text" name="long_title" value="{{$editdata->short_title}}" class="form-control">
                 </div>
