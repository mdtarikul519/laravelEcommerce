        ...
        <div class="container">
            <div class="flex-w flex-sb-m p-b-52">
                <div class="flex-w flex-l-m filter-tope-group m-tb-10">
                    ...
                    @foreach ($catagoris as $category)
                        <a class="stext-106 cl6 hov1 bor3 trans-04 m-r-32 m-tb-5"
                            href="{{ route('category.wise.products', $category->category_id) }}">
                            {{ $category['category']['name'] }}</a>
                    @endforeach

                </div>

                @include('forntend.layouts.search')
                        ...
                        <div>
                            ...
                            <div style="padding: 0px 20px 20px 20px;">
                                @foreach ($brands as $brand)
                                    <a class="stext-106 cl6 hov1 bor3 trans-04 m-r-32 m-tb-5"
                                        href="{{ route('brand.wise.products', $brand->brand_id) }}"
